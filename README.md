...
```bash
python inference.py --data_dir my_dataset/processed_graphs --model_path pretrained_models/mcgcnn_pretrained_tot_mom_v1.pt
```
...
If you use **mCGCNN** in your research, please cite our paper:
...
```
mCGCNN is built upon the Crystal Graph Convolutional Neural Network (CGCNN) framework. If you use this repository, please also consider citing the original CGCNN paper:
```bibtex
